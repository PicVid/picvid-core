 ...
 */
class IsUniqueUsername implements ISpecification
{
    /**
    ...
    public function isSatisfiedBy(IEntity $user): bool
    {
        ...
        //return the state if an User Entity with the username already exists.
        return (count(UserRepository::build()->findByUsername($user->username)) === 0);
    }
}